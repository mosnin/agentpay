...
interface MorphSurfaceProps {
  ...
  /**
   * Agent Market adaptation: when false, the wrapper doesn't reserve the
   * expanded footprint in layout — required when the surface floats in a
   * `fixed` container (e.g. the app-shell feedback dock).
   */
  reserveSpace?: boolean
  /** Agent Market adaptation: the label shown beside the status dot. */
  dockLabel?: string
  ...
  return (
    ...
    >
      <motion.div
        ...
        className={cn(
          "relative flex flex-col items-center bottom-0 z-10 overflow-hidden",
