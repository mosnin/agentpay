...
// Agent Market adaptation: the upstream "closed" variant carried no width
// target, so the panel never shrank back after opening. Both states are
// explicit now, and open fills the container.
  ...
  ({ panelOpen, handlePanelOpen, className, renderButton, children }, ref) => {
    ...
    return (
      <ResizablePanel>
        <motion.div
          className={cn(
            "w-[260px] max-w-full rounded-2xl bg-neutral-900",
            className
          )}
