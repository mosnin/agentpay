  ...
  return (
    ...
    >
      <motion.div
        ...
        className={cn(
          "group/elastic-slider absolute inset-0 cursor-pointer touch-none select-none overflow-hidden rounded-lg bg-muted outline-none",
      ...
      >
          ...
          {Array.from({ length: hashMarkCount }, (_, i) => (
            <div
              ...
              className={cn(
                ...
                "bg-transparent group-data-[active=true]/elastic-slider:bg-muted-foreground/30"
              )}
        ...
        <motion.div
          ...
          className={cn(
            ...
            "bg-primary/10 group-data-[active=true]/elastic-slider:bg-primary/20"
          )}
        ...
        <span
          ...
          aria-hidden="true"
          className="pointer-events-none absolute left-3 top-1/2 inline-flex -translate-y-1/2 items-center text-sm font-medium leading-none text-muted-foreground transition-colors"
        >
          {label}
        </span>
        ...
        <span
          ...
          aria-hidden="true"
          className={cn(
            "pointer-events-none absolute right-3 top-1/2 -translate-y-1/2 font-mono text-sm font-medium leading-none transition-colors",
            "text-muted-foreground group-data-[active=true]/elastic-slider:text-foreground"
          )}
        >
          {displayValue}
        </span>
