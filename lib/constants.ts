...
export const CATEGORIES = [
  {
    ...
    label: "Growth",
    icon: "TrendingUp",
    description: "Demand gen, outbound, and pipeline.",
  },
  {
    value: "Research",
    label: "Research",
    icon: "Microscope",
    description: "Synthesis, briefs, and citations.",
  },
  {
    value: "Coding",
    label: "Coding",
    icon: "Code2",
    description: "Review, tests, and bug detection.",
  },
  {
    value: "Data",
    label: "Data",
    icon: "Database",
    description: "Cleaning, mapping, and enrichment.",
  },
  {
    value: "Design",
    label: "Design",
    icon: "Palette",
    description: "UX audits and conversion review.",
  },
  {
    value: "Operations",
    label: "Operations",
  ...
  },
  {
    ...
    label: "Finance",
    icon: "Landmark",
    description: "Analysis and reconciliation.",
  },
  {
    value: "Security",
    label: "Security",
    icon: "ShieldCheck",
    description: "Audits and vulnerability scans.",
  },
  {
    value: "Customer Support",
    label: "Customer Support",
    icon: "LifeBuoy",
    description: "Triage and response drafting.",
  },
  {
...
export const PRICING_MODELS = [
  {
    value: "per_task",
    label: "Per task",
    description: "Flat price per completed task.",
  },
  {
    value: "subscription",
    label: "Subscription",
    description: "Recurring access to the agent.",
  },
  { value: "bounty", label: "Bounty", description: "Pay on accepted result." },
  {
    value: "hourly",
    label: "Hourly",
    description: "Metered by execution time.",
  },
] as const;
...
export const PAYMENT_MODES = [
  {
    value: "mock_escrow",
    label: "Mock escrow",
    description: "Funds held until validation passes.",
  },
  {
    value: "pay_per_task",
    label: "Pay per task",
    description: "Charged on task creation.",
  },
  {
    value: "subscription_access",
    label: "Subscription access",
    description: "Covered by an active plan.",
  },
  {
    value: "bounty",
    label: "Bounty",
    description: "Released to the first valid artifact.",
  },
] as const;
...
export const VISIBILITY_OPTIONS = [
  ...
  { value: "private", label: "Private", description: "Only you can see it." },
  {
    value: "unlisted",
    label: "Unlisted",
    description: "Reachable by direct link.",
  },
] as const;
...
export const TASK_STATUS_CONFIG: Record<string, StatusConfig> = {
  ...
  cancelled: {
    label: "Cancelled",
    className:
      "border-zinc-600/30 bg-zinc-600/10 text-zinc-600 dark:text-zinc-400",
    dot: "bg-zinc-500",
  },
};
...
export const MARKETPLACE_SORTS = [
  { value: "reputation", label: "Activity index" },
...
export const APP_TAGLINE = "The trust network for people and agents";
